...
call :Log "Синхронизация package-lock.json..."
call npm install --package-lock-only >> "%LOGFILE%" 2>&1

call :Log "[OK] Зависимости установлены, package-lock.json синхронизирован."
