...
import { Vehicle, Employee, Organization } from '../../types';
...
import { getVehicles, getEmployees, getOrganizations } from '../../services/mockApi';
...
const BatchGeneratorModal: React.FC<BatchGeneratorModalProps> = ({ onClose, onSuccess }) => {
    ...
    const [grouping, setGrouping] = useState<GroupingDuration>('day');
    ...
    const handleGeneratePreview = async () => {
        ...
        setIsLoading(true);
        try {
            const items = await generateBatchPreview(file, periodStart, periodEnd);
    ...
    const handleSave = async () => {
        ...
        try {
            await saveBatchWaybills(previewItems, config, vehicle, driver, (curr, tot) => {
        ...
        <div className="space-y-4">
            <div className="p-4 bg-blue-50 dark:bg-blue-900/30 rounded-lg border border-blue-200 dark:border-blue-800 text-sm">
                ...
                <ul className="list-disc list-inside mt-1 space-y-1">
                    ...
                    <li>Будет применен производственный календарь (5/2 + праздники РФ).</li>
